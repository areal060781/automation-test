export default [
  {
    ...
    show: {
      ...
      image: null,
      summary:
        '<p>An examination of the anatomy of corruption in Gotham City, the series is a prequel to <i>The</i> <i>Batman "</i>Year Two" movie, with the show set in "Year One" when a masked vigilante starts to unsettle the city. The series will zero in on the city\'s corruption that goes back many years, and is told from the POV of a crooked cop.</p>',
      updated: 1598265826,
      _links: {
        self: {
          href: "http://api.tvmaze.com/shows/49878",
        },
      },
    },
  },
  ...
  },
  {
    ...
    show: {
      ...
      summary:
        "<p><b>The New Batman Adventures</b> comes from the creators of Batman and Superman. This series was created because Fox had not lived up to the contract that they had given Batman, so the WB decided to give the show another chance. Bruce Timm then went back and decided to re-design all of the characters from Batman and ended up revamping the series all-together.</p>",
      updated: 1601066374,
      _links: {
        self: {
